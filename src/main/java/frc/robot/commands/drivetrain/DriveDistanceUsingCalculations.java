...
public class DriveDistanceUsingCalculations extends CommandBase {
  ...
  public DriveDistanceUsingCalculations(DriveTrain driveTrain, double diameterOfWheel, double toGetDistanceInInches, double speed) {
  ...
  @Override
  public void execute() {
    driveTrain.driveDistance(diameterOfWheel, toGetDistanceInInches, speed);
  }
